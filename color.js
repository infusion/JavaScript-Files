...
function Color(color) {
	...
	if (this.success) {
		...
		var b = new Color(table[i]).getHSL();
...
function ColorMix() {
	...
	if (c.success) {
	    ...
	    return [c,
	    new Color([c.b, c.r, c.g]),
	    new Color([c.g, c.b, c.r])];
	}
	return null;
    }
	...
	if (c.success) {
	    ...
	    return [c,
	    new Color([c.b, c.r, c.b]),
	    new Color([c.b, c.g, c.r]),
	    new Color([c.r, c.b, c.r])];
	}
	return null;
    }
	...
	var a = new Color(arr[e]);
	var b = new Color(arr[e + 1]);
